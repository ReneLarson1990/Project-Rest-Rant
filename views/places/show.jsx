              ...
              <form className="row g-3" method="POST" action={`/places/${data.place.id}/comment`}>
                ...
                <div className="col-md-3">
                  <div className="form-check">
                    <label className="form-check-label" htmlFor="rant" id="rant-checkbox">😡Rage-Rant?😡
                    <br></br>“My life ends only when my rage has been vented, when my need for vengeance is satisfied. It will be a long life.” ― Darth Maul<br></br><i> Click Below to Submit Comment as a Rant!!!</i>
</label>
                    <br/>
